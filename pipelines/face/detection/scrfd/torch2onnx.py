...
from pipelines.face.detection.scrfd.mmdet.core import (build_model_from_cfg, generate_inputs_and_wrap_model,
                                                       preprocess_example_input)

#from pipelines.face.detection.scrfd.mmdet.models import build
...
if __name__ == '__main__':
    ...
    if len(args.output_file) == 0:
        ...
        if dynamic:
            ...
            args.output_file = osp.join(output_dir, "%s_shape%dx%d.onnx" % (
