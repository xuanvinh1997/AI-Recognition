...
from pipelines.face.detection.scrfd.mmdet.core import (bbox2roi, bbox_mapping, merge_aug_bboxes,
                        merge_aug_masks, multiclass_nms)

logger = logging.getLogger(__name__)

if sys.version_info >= (3, 7):
    from pipelines.face.detection.scrfd.mmdet.utils.contextmanagers import completed
